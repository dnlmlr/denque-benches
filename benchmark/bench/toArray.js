...
var denqueMod_NonContiguous = new DenqueMod();
var denqueMod_NonZeroHead = new DenqueMod();
...
for (var i = 0; i < l; i++) {
  ...
  denqueMod.push(i);
  denqueMod_NonContiguous.push(i);
  denqueMod_NonZeroHead.push(i);
...
suite
  ...
  .add('denque (mod) (head at 0)', function () {
  ...
  .add('denque (mod) (non-contiguous)', function () {
    var arr = denqueMod_NonContiguous.toArray();
  })
  ...
  .add('denque (mod) (non zero head)', function () {
    var arr = denqueMod_NonZeroHead.toArray();
  })
